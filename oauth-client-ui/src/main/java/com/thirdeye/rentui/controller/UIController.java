package com.thirdeye.rentui.controller;
...
import com.thirdeye.rentui.config.AccessToken;
import com.thirdeye.rentui.model.Customer;
	...
	public String loadCustomers(Model model) {
		...
		try {
			ResponseEntity<Customer[]> responseEntity = restTemplate.exchange(
					"http://localhost:9195/services/profiles", HttpMethod.GET, customerHttpEntity, Customer[].class);
